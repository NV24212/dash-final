        ...
        <DialogHeader className="space-y-4">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1 space-y-3">
              <DialogTitle className="text-lg font-semibold text-gray-900 text-left rtl:text-right">
                {title}
              </DialogTitle>
              <DialogDescription className="text-sm text-gray-600 text-left rtl:text-right leading-relaxed">
                {message}
              </DialogDescription>
            </div>
          </div>
