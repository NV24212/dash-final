...
const translations = {
  en: {
    ...
    'empty.noProductsStart': 'Start by adding your first product',
    'empty.noProductsSearch': 'Try adjusting your search terms',
    'empty.addProduct': 'Add Product',
    'empty.noCustomersFound': 'No customers found',
    'empty.noCustomersStart': 'Start by adding your first customer',
    'empty.noCustomersSearch': 'Try adjusting your search terms',
    'empty.addCustomer': 'Add Customer',
    'empty.noOrdersFound': 'No orders found',
    'empty.noOrdersStart': 'Start by creating your first order',
    'empty.noOrdersSearch': 'Try adjusting your search terms',
    'empty.createOrder': 'Create Order',
    'empty.noDashboardOrders': 'No orders yet. Create your first order to see it here!',
  ...
  ar: {
    ...
    // Empty state messages
    'empty.noProductsFound': 'لم يتم العثور على منتجات',
    'empty.noProductsStart': 'ابدأ بإضافة منتجك الأول',
    'empty.noProductsSearch': 'جرب تعديل مصطلحات البحث',
    'empty.addProduct': 'إضافة منتج',
    'empty.noCustomersFound': 'لم يتم العثور على عملاء',
    'empty.noCustomersStart': 'ابدأ بإضافة عميلك الأول',
    'empty.noCustomersSearch': 'جرب تعديل مصطلحات البحث',
    'empty.addCustomer': 'إضافة عميل',
    'empty.noOrdersFound': 'لم يتم العثور على طلبات',
    'empty.noOrdersStart': 'ابدأ بإنشاء طلبك الأول',
    'empty.noOrdersSearch': 'جرب تعديل مصطلحات البحث',
    'empty.createOrder': 'إنشاء طلب',
    'empty.noDashboardOrders': 'لا توجد طلبات حتى الآن. أنشئ طلبك الأول لتراه هنا!',
